 ...
 * @author ASUS
 */
public class CariAyat extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CariAyat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
